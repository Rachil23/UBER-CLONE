...
const VehiclePanel = (props) => {
  ...
  props.setSelectedVehicle({
    name: 'UberGo',
    image: 'https://www.uber-assets.com/image/upload/v1699622825/assets/26/12256b-fe40-4f78-b94c-d2ffdec56a23/original/UberBlack.png',
    timeAway: '8 mins',
    price: 193.20
  });
  ...
  props.setConfirmRidePanel(true);
        ...
        transition-all rounded-xl mb-2 px-2.5 py-2.5 w-full items-center justify-between">
          ...
          <div className="w-1/2">
            ...
            <h5 className="font-medium text-base text-gray-800 ">3 mins away </h5>
