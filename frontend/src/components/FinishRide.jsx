...
const FinishRide = (props) => {
    ...
    const endRide = async () => {
        try {
            const response = await axios.post('http://localhost:5000/api/captain/finish-ride', {
    ...
    */ }
    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-between p-4 border-1 bg-gray-100 rounded-lg mt-4'>
